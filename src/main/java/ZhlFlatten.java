...
public class ZhlFlatten {
	...
	public static void main(String[] args) {
		...
		JavaRDD<Tuple2<ArrayList<ModifiedRow>, ArrayList<CommonRow>>> tupleData = mLines.join(oLines).values().distinct();
		JavaRDD<LabeledPoint> data = tupleData.flatMap(new GetVectorScoresWithoutBadvBcat()).cache();
		JavaRDD<String> actualMatchStrings = tupleData.flatMap(new GetVectorScoresWithStringsWithoutBadvBcat());
